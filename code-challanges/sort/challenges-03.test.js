...
const sortBackwards = (arr) => {
  // Solution code here...
  console.log('first1',arr.sort((a,b)=>a<b));
...
const alphabetizeBetter = (arr) => {
  // Solution code here...
  console.log('seconde2',arr.sort((a,b)=>a.toUpperCase()>b.toUpperCase()));
...
const sortPeopleBetter = (arr) => {
  ...
  return arr.sort((a,b)=>{
    ...
    else if(a.lastName===b.lastName&&a.firstName.toUpperCase()>b.firstName.toUpperCase()){
      return 1;
...
const sortMeetingsByDay = (arr) => {
  // Solution code here...
  return arr.sort((a,b)=>{
    var days =['Monday','Tuesday','Wednesday','Thuresday','Friday'];
...
const sortSchedule = (arr) => {
  ...
  return arr.sort((a,b)=>{
    var days =['Monday','Tuesday','Wednesday','Thuresday','Friday'];
    if(a.start===b.start&&days.indexOf(a.dayOfWeek)===days.indexOf(b.dayOfWeek)){
      if(a.end<b.end){
        return -1;
      }else{
        return 1;
