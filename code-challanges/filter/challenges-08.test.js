...
const filterStringsWithVowels = (arr) => {
  // Solution code here...
  return arr.filter(el=>el.includes('a')||el.includes('e')||el.includes('o')||el.includes('u')||el.includes('i'));
};
...
const notInFirstArray = (forbiddenValues, arr) => {
  // Solution code here...
  return arr.filter(el=>!forbiddenValues.includes(el));
};
...
const getBaseStatGreaterThan = (arr, minBaseStat) => {
  // Solution code here...
  var filtered =arr.filter(ob=>ob.baseStat>minBaseStat);
...
const getStatName = (arr, minBaseStat) => {
  ...
  return filtered.map(el=>el.stat.name);
};
...
const getCharactersWithoutChildren = (arr) => {
  // Solution code here...
  return arr.filter(ob=> !ob.children);
};
...
const evenOddNumericValues = (arr) => {
  // Solution code here...
  var filtered = arr.filter(e=>typeof e === "number");
